class Score {
    constructor(firstBallIndex, lastBallIndex, score) {
        let firstBall = balls[firstBallIndex];
        let lastBall = balls[lastBallIndex];
        ...
        scoreEl.innerHTML = +scoreEl.innerHTML + this.score * scoreMultiplier;
